...
<h3 class="p-3 p-md-5 text-center"><strong>TRANSAKSI</strong></h3>
<hr class="bg-white">
        <?php   
...
<?php endif; ?>       
          <button type="button" class="btn btn-block btn-danger" data-toggle="modal" data-target="#posMODAL">BAYAR</button>
          ...
          <div class="modal-dialog modal-dialog-centered" role="document">
            <div class="modal-content">
              <div class="modal-header bg-danger">
                <h5 class="modal-title text-text-white" id="exampleModalCenterTitle">PEMBAYARAN</h5>
                    ...
                    <div class="col-sm-12 mb-2">
                      <div class="input-group mb-2">
                        <div class="input-group-prepend">
                          ...
                          <input class="form-control text-right" id="txtNumber" onkeypress="return isNumberKey(event)" type="text" name="cash" placeholder="Uang yang dibayar" name="cash" required>
                    </div>
                  </div>
              </div>
              <div class="modal-footer">
                <button type="submit" class="btn btn-danger btn-block">SIMPAN PEMBAYARAN</button>
              </div>
            </div>
          </div>
        </div>
