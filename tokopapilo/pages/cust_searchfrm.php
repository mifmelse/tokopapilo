...
if ($Aa=='User'){
?>
<script type="text/javascript"> alert("Halaman dibatasi! Anda akan diarahkan ke menu kasir"); window.location = "pos.php"; </script>
<?php   }
}   
...
?>
            ...
            <div class="card-header py-3">
              <h4 class="m-2 font-weight-bold text-primary">Table details</h4>
            </div>
