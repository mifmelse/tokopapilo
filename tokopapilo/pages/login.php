...
<body class="bg-gradient-danger">
  ...
  <div class="container">
  <h3 class="text-white text-center p-3 p-md-3">Login Website Dapur Bunda Bahagia</h3>
      ...
      <div class="col-xl-10 col-lg-12 col-md-9">
        ...
        <div class="card o-hidden border-0 shadow-lg my-5">
          <div class="card-body p-0">
            ...
            <img src="../img/logonih.png" width="400" class="img-fluid p-3 p-md-3">
              <div class="col-lg-6">
                <div class="p-5">
                  <div class="text-center">
                    <h1 class="h4 text-gray-900 mb-4"><span class="text-danger font-weight-bold">Dapur Bunda Bahagia</span>
                  </div>
                  <form class="user" role="form" action="processlogin.php" method="post">
                    ...
                    <button class="btn btn-danger btn-user btn-block" type="submit" name="btnlogin">Login</button>
                    <hr>
...
<p class="text-white text-center"><span>Wadidiw</span>
</p>
  </div>
