...
<h3><span class="glyphicon glyphicon-briefcase"></span>  Laporan Penjualan</h3>
...
<?php
 ...
 if($xr['total']< 0){ ?>
	<td colspan="7">Status :<p style="color:red; float:right; font-weight:bold;margin-right:1000px;"> <?= 'Rugi'; ?> </p> </p> </td>
<?php	}elseif($xr['total'] == 0){ ?>
	<td colspan="7">Status :<p style="color:black; font-weight:bold; float:right; margin-right:990px;"> <?= 'Modal'; ?> </p> </td>
 <?php }else{ ?>
<td colspan="7">Status :<p style="color:green; float:right; font-weight:bold; margin-right:980px;"> <?= 'Untung' ;?> </p> </td>
<?php } ?>
